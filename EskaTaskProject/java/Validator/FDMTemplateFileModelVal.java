...
public class FDMTemplateFileModelVal {
	...
	public FDMTemplateFileModelVal() {
		super();
	}

	public FDMTemplateFileModelVal(int ID, int TYPE_ID, String TAG_NAME, int ORDER, boolean IS_CONDITIONAL_TAG) {
		super();
		this.ID = ID;
